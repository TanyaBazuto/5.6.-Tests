# Задание 1. Соберите уникальные имена преподавателей.
...
# Задание 2. Суперимена: преподаватели с какими именами учат сразу на двух курсах?
...
# Задание 3. Это вы мне? Подсчитываем тёзок на каждом курсе.
